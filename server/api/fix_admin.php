...
try {
    ...
    $platformKeys = [
        ...
        'seo_title' => 'Bee Chat | AI-Powered Support Platform',
        'seo_description' => 'Fast, intelligent, and real-time AI-powered customer support.',
        'enable_registration' => '1',
        'enable_ai_bot' => '1',
        'enable_live_chat' => '1',
        'enable_ticketing' => '1',
        'enable_billing' => '1',
        'landing_page_active' => '1' // <--- Crucial for landing page rendering
    ];
